...
const categoryPalettes = {
  Motivation: ["#241738", "#0A0710"],
  Amitié: ["#1B2438", "#0A0710"],
  Amour: ["#38172A", "#0A0710"],
  Force: ["#382417", "#0A0710"],
  Perte: ["#171B38", "#0A0710"],
};
...
function drawQuoteCard(q) {
  ...
  const [c1, c2] = categoryPalettes[q.category] || ["#160F22", "#0A0710"];
  ...
  ctx.strokeStyle = "rgba(224,188,122,0.3)";
  ctx.lineWidth = 2;
  ...
  ctx.fillStyle = "#E0BC7A";
  ctx.font = "bold 34px Georgia, serif";
  ctx.fillText(q.character.toUpperCase(), 110, H - 160);
